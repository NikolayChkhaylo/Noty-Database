...
word_bank = {
    ...
    'Вок. 3-о': {'Вокал - трио', 'Трио', 'Вокал 3-о', 'Вокал 3-о - аккорды','Ансамбль 3-о', 'Вокальное 3-о'},
    'Вок. 4-т+': {'Квартет или группа м.хора'},
    'Скр. 1': {'Скр. 1/соло', 'скрипка'},
    'Стр. 2-т': {'2 скр','Скр. 2-т','Скрипки 2-т'},
    'Стр. 3-о': {'Скр. 3-о'},
    ...
    'Молодёжный хор, Фортепиано': {'Молодёжный хор и фортепиано'},
    'Стр. 2-т, Фортепиано': {'2 скр фно'},
