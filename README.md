...
However, with each new solution comes a new problem. The accuracy of ScanScore depends on the clarity of the PDF of the sheet music. Sometimes the PDF can clearly distinguish an export coming from some music software(our best case scenario). Other times, the PDF can be clearly seen to have been taken from a book which introduces awkward orientation of the page, dark spots from shadows, uneven lighting, and in some rare cases we have notes being cut off(worst case). This would either force us to go in manually for a correction or just make a recording of the song by ourselves. 
...
# Final notes
With plenty of music being learned by recordings and instead of notes, I have decided to start writing notes to make sure the song is accurately recorded and the musicans don't have to rely on their hearing to accurately distinguish each note. The current database is just a baseline for the songs that have already been written out note by note for the musican. However, even with all of these songs at my fingertips, I still recieve plenty of request to play songs that are not in the database and sometimes don't even have recordings. This is due to the fact that there are emerging composers who have the melody and words in their head, but may struggle to accurately write out the melody for the musican to play exactly as they think to play it. I have explored several options for coming up with a semi-automated solution and considered anthem score(Paid AI software that maps out the audio recording of any song on to the piano and makes sheet music). However, just like all AI software, this can often be a hit or miss. Furthermore, the audio has to be accurate and on beat for me to not need to modify anything. If the melody is simple, at best the AI will get the accurate notes but will struggle with mapping out the beats on time. This is why this software is only most useful if there is a midi recording. However, if there is a midi recording, then most likely the notes are already written out so there is no need for the use of this software. All in all, this project was a success for the most part but I expected to discover more automation for music transcribing.      
